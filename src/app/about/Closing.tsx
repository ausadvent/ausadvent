...
export default function Closing() {
  return (
    <div className='p-[2rem] sm:py-[4rem] lg:py-[4.5rem] xl:py-[5rem] 2xl:py-[6rem] sm:px-[4.38rem] lg:px-[8rem] 3xl:px-[12rem] bg-gradient-to-b from-[#F59E0B] to-[#F9B84B] rounded-tr-[3rem] rounded-bl-[3rem] '>
