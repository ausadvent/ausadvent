...
export default function Intro({article}: any) {
    return (
        <section className="page sm:mx-auto pb-[2rem] sm:pb-0 ">
            {/* Background image */}
            <div className="absolute inset-0 h-[43.5rem] sm:h-[45.5rem] md:h-[48.5rem] xl:h-[62.5rem] -z-10">
                <Image 
                    ...
                    unoptimized
                />
                <div className="absolute inset-0 bg-[#1e3a8a] opacity-60 " aria-hidden="true"></div>
            </div>
            ...
            <div className=' pt-[8rem]  md:pt-[4.5rem] lg:pt-[8rem] xl:pt-[12rem] h-[38rem] sm:h-[42rem] md:h-[44rem] xl:h-[58rem] text-primaryWhite '>
                ...
                <div className="lg:mt-[3rem] flex flex-col lg:flex-row lg:gap-[1rem] xl:gap-[2rem]">
                    <div className=' lg:w-1/2'>
                        <h1 className="mt-[1rem] lg:mt-0 text-[1.875rem] md:text-[1.875rem] lg:text-[2rem] xl:text-[3rem] 3xl:text-[4rem] leading-[1.85rem] md:leading-[1.75rem] lg:leading-[1.9rem] xl:leading-[2.875rem] 3xl:leading-[3.75rem] font-black  ">
