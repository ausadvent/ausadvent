            ...
            <div className='page pt-[2rem] md:pt-[4.5rem] lg:pt-[8rem] xl:pt-[12rem] h-[38rem] sm:h-[42rem] md:h-[44rem] xl:h-[58rem] text-primaryWhite '>
                ...
                <div className="lg:mt-[3rem] flex flex-col lg:flex-row lg:gap-[1rem] xl:gap-[2rem]">
                    <div className=' lg:w-1/2'>
                        <h1 className="mt-[1rem] lg:mt-0 text-[1.875rem] md:text-[1.875rem] xl:text-[2rem] 2xl:text-[3rem] 3xl:text-[4rem] leading-[1.85rem] md:leading-[1.75rem] xl:leading-[2rem] 2xl:leading-[2.875rem] 3xl:leading-[3.75rem] font-black  ">{article.fields.articleTitle}</h1>
                    ...
                    <div className='mt-[2rem] flex flex-col gap-[1rem]  '>
                        {article.fields.introductoryText.content.map((idea: any, index: number) => (
                            <p key={index}>{idea.content[0].value}.</p>
                        ))}
                    </div> 
                </div>
            </div>
