...
export default function Way() {
  return (
    <div className='  lg:max-w-[748px] xl:max-w-[1004px] 2xl:max-w-[1260px] 3xl:max-w-[1516px] px-[2rem] py-[2rem] lg:py-[4rem] bg-gradient-to-b from-[#FFD8AF] to-[#FDBA74] rounded-tr-[2rem] rounded-bl-[1rem]  '>
