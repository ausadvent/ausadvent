...
export default function Description() {
  return (
    <section className='relative'>
        ...
        {/* Content */}
        <div className='page sm:mx-auto pt-[13rem] sm:pt-[8rem] pb-[2rem] '>
            <div className="flex flex-col gap-[1.5rem]">
                <h2 className='cormorant text-[1.5rem] lg:text-[1.875rem] font-bold text-[#6B7280] '>Jump To Section</h2>
            ...
            <div className=" mt-[2rem] md:mt-[4rem] flex flex-col gap-[4rem]">
                {/* Box for Understanding */}
                <div className="flex flex-col gap-[2rem]">
                    <h2 className='cormorant text-[1.5rem] lg:text-[1.875rem] font-bold text-blueHigher '>Understanding The NDIS</h2>
                    <p className='text-[#374151] lg:text-[1.125rem]'>The NDIS, or National Disability Insurance Scheme, represents a groundbreaking initiative designed to empower individuals with disabilities. Unlike traditional models, the NDIS places the power directly in the hands of the person in need, providing them with financial support and the autonomy to choose the type and level of support that aligns with their individual needs and aspirations.</p>
                </div>
                {/* Box for Eligibility */}
                <div className="flex flex-col lg:flex-row gap-[2rem] text-[#374151]">
                    <div className='lg:w-1/2 flex flex-col gap-[2rem]'>
                        <h2 className='cormorant text-[1.5rem] lg:text-[1.875rem] font-bold text-blueHigher '>Eligibility For NDIS</h2>
                        <p className='lg:text-[1.125rem]'>The NDIS is available for individuals who meet the following criteria:</p>
                    ...
                    <div className="lg:w-1/2 p-[1rem] flex flex-col gap-[2rem] border-[1px] border-[#2563EB] rounded-[0.5rem] text-[#374151] lg:text-[1.125rem]">
