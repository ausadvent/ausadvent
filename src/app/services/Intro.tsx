    ...
    <div className='bg-[#2563EB] h-screen -mt-[4rem]'>
        <div className='page sm:mx-auto pt-[6rem] sm:pt-[4rem] lg:pt-[6rem] pb-[2rem] h-full'>
            <div className="h-full flex flex-col 2xl:flex-row justify-between sm:justify-around 2xl:items-center 2xl:gap-[4rem] 3xl:gap-[6rem] text-primaryWhite ">
                ...
                <h2 className='2xl:hidden cormorant text-[1.5rem] sm:text-[1.875rem] lg:text-[2.25rem] sm:leading-8 lg:leading-[2.375rem] font-bold '>Empowering Independent Living Across Queensland and Western Australia</h2>
                ...
                <div className="flex flex-col gap-[2rem]">
                  ...
                  <h2 className='hidden 2xl:inline cormorant text-[1.5rem] sm:text-[1.875rem] lg:text-[2.25rem] sm:leading-8 lg:leading-[2.375rem] font-bold '>Empowering Independent Living Across Queensland and Western Australia</h2>
                </div>

                <div className="flex flex-col gap-[1rem] 2xl:gap-[2rem] lg:text-[1.125rem] 2xl:text-[1.25rem]">
                    <p className='font-semibold'>At Ausadvent Care, we&apos;re more than just WA and QLD&apos;s trusted Disability Support partner with NDIS expertise.</p>
                    <p>We&apos;re your national champion for independent living, proudly guiding individuals towards vibrant lives throughout our <Link href='locations' >areas of service</Link>.</p>
