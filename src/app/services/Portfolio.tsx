...
export default async function Portfolio({services}:any) {
    ...
    <div className='page sm:mx-auto py-[3.5rem] sm:py-[4rem]'>
        <div className='md:flex md:items-center gap-[3rem]'>
            <p className='text-[1rem] md:w-[14.625rem]'>Our <strong>Supported Accommodation</strong> portfolio offers four distinct avenues to empower your unique journey, wherever you call home.</p>
                ...
                <div className="flex flex-col gap-[0.5rem]">
                    {services.map((service: any, index: any) => (
                        <Link href={`/services#${service.fields.serviceUrl}`} scroll key={index} className="flex items-center gap-[0.5rem]">
                            ...
                            <p className='cormorant text-[1.20rem] md:text-[1rem] text-[#2563EB]'>{service?.fields.serviceTitle}</p>
